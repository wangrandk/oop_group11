...
public class MediumBoard extends Board {
	...
	*/
    private final int[][] boardSettings = {   
    		{11,  11,  0, 11,  6,  0, 13, 11,  5, 11, 13,  0,  0, 11, 11},
    		{11,  11,  0,  6,  0, 12, 12, 12, 12, 12, 12,  0,  0, 11, 11},
    		{ 0,   0,  0, 11,  0,  0,  0,  6,  0,  0,  6,  0,  0,  0,  5},
    		{12,  12,  0,  6,  0,  0,  0, 11,  0,  0, 11,  0,  6,  0,  0},
    		{12,   4,  0, 12,  0,  0, 11,  0, 11,  0,  5,  0, 11, 12, 12},
    		{12,  12,  0,  6,  0, 11,  5, 11,  5, 11,  0,  0,  6,  3, 11},
    		{12,   4,  0, 12,  0,  0, 11,  0, 11,  0,  5,  0, 11, 12, 12},
    		{12,  12,  0,  6,  0,  0,  0, 11,  0,  0, 11,  0,  6,  0,  0},
    		{ 0,   0,  0, 11,  0,  0,  0,  6,  0,  0,  6,  0, 13,  0,  0},
    		{ 0,   0,  0,  6,  0,  0,  0, 11,  0,  0, 11,  0,  0,  0,  5},
    		{11,  11,  0, 11,  0, 12, 12, 12, 12, 12, 12,  0,  0, 11, 11},
