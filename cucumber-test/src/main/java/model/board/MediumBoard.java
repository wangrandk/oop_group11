...
public class MediumBoard extends Board {
	...
	*/
    private final int[][] boardSettings = {   
    		...
    		{12,  12,  5, 11,  0,  0,  0,  0,  5,  0,  0,  0, 11,  5,  12},
    		{12,  12, 11, 11,  6,  0,  0,  0,  0,  0, 12,  0, 11, 11,  12},
    		{12,  12,  0,  0,  6,  6,  6,  6,  6,  6,  6,  6, 11,  0,  12},
    		{12,   4,  0,  0,  6,  5, 11,  6,  6, 11, 13,  6, 11,  0,  12},
    		{12,  12,  0,  0,  6, 11, 13,  0,  0, 13, 11,  6,  0,  0,  12},
    		{12,   4,  0,  0,  6, 13, 11,  3,  0, 11, 13,  6,  0,  0,  12},
    		{12,  12,  0,  0,  6, 11, 13,  6,  6, 13,  5,  6,  0,  0,  12},
